 ...
 */
class LeaseSeveralOperationTest extends TestCase
{
    /**
    ...
    public function test_periodIsBusy_failedWithOverlapInfo()
    {
        // -- Arrange
        {
            ...
            $contractsRepo
                ->getForSlave($slave1->getId(), '2017-01-01', '2017-02-01')
            ...
            $leaseRequest->timeTo = '2017-02-01 02:01:00';
        ...
        // -- Assert
        $expectedErrors = ['Ошибка. Раб #1 "Уродливый Фред" занят. Занятые часы: 2017-01-01 01, 2017-01-01 02, 2017-01-01 03'];
